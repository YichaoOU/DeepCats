...
if __name__ == "__main__":
  ...
  # flags.DEFINE_integer("netvlad_cluster_size", 256,"liyc own addition")
  # flags.DEFINE_integer("netvlad_hidden_size", 500,"liyc own addition")
  # flags.DEFINE_integer("moe_l2", 1e-6,"liyc own addition")
  # flags.DEFINE_integer("iterations", 300,"liyc own addition")
  # flags.DEFINE_bool("netvlad_relu", True,"liyc own addition")
  # flags.DEFINE_bool("gating", True,"liyc own addition")
  # flags.DEFINE_bool("moe_prob_gating", True,"liyc own addition")
  # flags.DEFINE_bool("lightvlad", True,"liyc own addition")
  ...
  flags.DEFINE_integer("export_model_steps", 20000,
  ...
  def run(self, start_new_model=False):
    ...
    with tf.Graph().as_default() as graph:
      ...
      with tf.device(device_fn):
        ...
        for xx in tf.get_collection("train_op"):
        # for xx in tf.get_collection(tf.GraphKeys.VARIABLES):
        # for xx in tf.global_variables():
            print xx
